...
class DespesaFormParcela extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de Parcelas (Despesa)");
        ...
        $criteria_categoria_id->add(new TFilter('tipo_categoria_id', 'in', "(SELECT id FROM tipo_categoria WHERE id = '{$filterVar}')")); 
        $filterVar = TSession::getValue("userid");
        ...
        $style = new TStyle('right-panel > .container-part[page-name=DespesaFormParcela]');
