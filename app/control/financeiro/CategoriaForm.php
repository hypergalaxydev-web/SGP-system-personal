...
class CategoriaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new THidden('id');
        $tipo_categoria_id = new TDBRadioGroup('tipo_categoria_id', 'bd_sgp', 'TipoCategoria', 'id', '{descricao}','id asc' , $criteria_tipo_categoria_id );
        $totaliza_receita_despesa_id = new TDBRadioGroup('totaliza_receita_despesa_id', 'bd_sgp', 'TotalizaReceitaDespesa', 'id', '{descricao}','id asc' , $criteria_totaliza_receita_despesa_id );
