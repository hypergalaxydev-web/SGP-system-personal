...
class ReceitaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de Receita");
        ...
        $row1 = $this->form->addFields([new TLabel("Descrição:", '#607D8B', '14px', 'B', '100%'),$descricao,$id],[new TLabel("Vencimento:", '#607D8B', '14px', 'B', '100%'),$vencimento],[new TLabel("Valor:", '#607D8B', '14px', 'B', '100%'),$valor],[new TLabel("Recebimento:", '#607D8B', '14px', 'B'),$pagamento]);
        ...
        $style = new TStyle('right-panel > .container-part[page-name=ReceitaForm]');
