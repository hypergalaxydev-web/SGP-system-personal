...
class AgendamentoCalendarForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $criteria_relevancia_id = new TCriteria();
        $criteria_tipo_id = new TCriteria();
        $criteria_recorrencia_id = new TCriteria();
        $criteria_considera_final_semana_id = new TCriteria();
        $criteria_lembrete_agenda_id = new TCriteria();
        ...
        $relevancia_id = new TDBCombo('relevancia_id', 'bd_sgp', 'Relevancia', 'id', '{descricao}','descricao asc' , $criteria_relevancia_id );
        $tipo_id = new TDBCombo('tipo_id', 'bd_sgp', 'Tipo', 'id', '{descricao}','id asc' , $criteria_tipo_id );
        $recorrencia_id = new TDBCombo('recorrencia_id', 'bd_sgp', 'Recorrencia', 'id', '{descricao}','id asc' , $criteria_recorrencia_id );
        $limite_recorrencia = new TDate('limite_recorrencia');
        $considera_final_semana_id = new TDBCombo('considera_final_semana_id', 'bd_sgp', 'ConsideraFinalSemana', 'id', '{descricao}','descricao asc' , $criteria_considera_final_semana_id );
        $lembrete_agenda_id = new TDBCombo('lembrete_agenda_id', 'bd_sgp', 'LembreteAgenda', 'id', '{descricao}','id asc' , $criteria_lembrete_agenda_id );
        $id = new TEntry('id');
